...
import home from '../../assets/yummy/home.webp';
import mealdetails from '../../assets/yummy/mealdetails.webp';
import category from '../../assets/yummy/category.webp';
import area from '../../assets/yummy/area.webp';
import search from '../../assets/yummy/search.webp';
...
export default function YummyProject() {
    ...
    const images = [search, area, category, mealdetails, home];
    ...
    return <>
        <div className="relative min-h-screen xl:overflow-hidden">
            <ShaderBackground waveColor={0xf9bdbd} backgroundColor={0xfff200} />
            <div className=' flex flex-col xl:flex-row justify-between items-center xl:items-stretch mx-4 my-container xl:mx-14 gap-10 xl:gap-0'>
                <div className=' mt-10 md:mt-36 pt-2 xl:w-1/4 relative md:w-[55%] w-[85%] text-center xl:text-left' >
                    <h2 className='londrina text-7xl pb-7 eachprojectgsap'>Yummy</h2>
                    <p className='text-[#4c4a4a] pb-7 eachprojectgsap'>A website that displays meals and tells you the ingredients , it's home country, categories and how to make it.</p>
                    <a target="_blank" rel="noopener noreferrer" href="https://rawanmfa.github.io/Yummy/" className=' eachprojectgsap opacity-0 inline-block px-6 py-2 bg-black text-white rubik visit-button hover:bg-[#fff200] relative rounded-tl-[80%] rounded-bl-[50%] rounded-br-[80%] rounded-tr-[50%]'>Visit</a>
                </div>
                ...
                <div className='xl:mt-36 pt-2 xl:w-1/4 md:w-[55%] w-[85%]'>
                    ...
                    <p className='text-[#4c4a4a] my-width pb-2 eachprojectgsap'>HTML, CSS, JS, Bootstrap, fontawesome</p>
                    ...
                    <p className='text-[#4c4a4a] eachprojectgsap'>This website was made using HTML, CSS, JS and Bootstrap no framwork.</p>
                </div>
            </div>
