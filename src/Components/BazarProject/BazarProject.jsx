...
import one from '../../assets/bazar/1.webp';
import three from '../../assets/bazar/3.webp';
import five from '../../assets/bazar/5.webp';
import four from '../../assets/bazar/4.webp';
import two from '../../assets/bazar/2.webp';
...
export default function BazarProject() {

  const images = [five, four, three, two, one];
  ...
  return <>
    <div className="relative min-h-screen xl:overflow-hidden">
      <ShaderBackground waveColor={0xfff8e5} backgroundColor={0xe2460d} />
      <div className=' flex flex-col xl:flex-row justify-between items-center xl:items-stretch mx-4 my-container xl:mx-14 gap-10 xl:gap-0'>
        <div className=' mt-10 md:mt-36 pt-2 xl:w-1/4 relative md:w-[55%] w-[85%] text-center xl:text-left' >
          <h2 className='londrina text-7xl pb-7 eachprojectgsap'>Bazar</h2>
          <p className='text-[#4c4a4a] pb-7 eachprojectgsap'>The backend of an e-commerce application with product management, authentication, cart, checkout and much more functionalities.</p>
          <a target="_blank" rel="noopener noreferrer" href="https://github.com/rawanmfa/E-Commerece" className=' eachprojectgsap opacity-0 inline-block px-6 py-2 bg-black text-white rubik visit-button hover:bg-[#e2460d] relative rounded-tl-[80%] rounded-bl-[50%] rounded-br-[80%] rounded-tr-[50%]'>Visit</a>
        </div>
        ...
        <div className='xl:mt-36 pt-2 xl:pt-10 xl:w-1/4 md:w-[55%] w-[85%]'>
          ...
          <p className='text-[#4c4a4a] my-width pb-2 eachprojectgsap'>ASP.NET web API, LinQ, Entity framework, Authentication, Authorization, Jwt, SQL</p>
